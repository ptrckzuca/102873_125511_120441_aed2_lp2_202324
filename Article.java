...
import Project_102873_125511_120441_aed2_lp2_202324.Publication;
...
public class Article{
    ...
    public ArrayList<Article> getReferencias() {
        ArrayList<Article> referenciasAno = new ArrayList<>();
        for (Article a : referencias) {
            if (a.getAno() == ano) {
                referenciasAno.add(a);
            }
        }
        return referenciasAno;
    }

    public void setReferencias(ArrayList<Article> referenciasAno) {
        for (Article article : this.referencias = referenciasAno) {
            if (article.getAno() == ano) {
                referencias.add(article);
            }
        }
    }
